...
function(wl2_find_libmembus)
    ...
    set(WL2_LIBMEMBUS_PROVIDER_USED "" PARENT_SCOPE)
    ...
    if(NOT WL2_ENABLE_LIBMEMBUS OR WL2_LIBMEMBUS_PROVIDER STREQUAL "off")
        ...
        wl2_dependency_note_result(libmembus DISABLED "disabled")
        return()
    endif()
    ...
    if(WL2_LIBMEMBUS_PROVIDER STREQUAL "local" OR WL2_LIBMEMBUS_PROVIDER STREQUAL "auto")
        if(EXISTS "${WL2_LIBMEMBUS_ROOT}/include/libmembus.h")
            if(WL2_LIBMEMBUS_PROVIDER STREQUAL "auto"
                    AND NOT EXISTS "${WL2_LIBMEMBUS_ROOT}/include/libmembus/mempkt.h")
            ...
            foreach(_optional_source mempkt memcmd memkv helpers select sys)
            ...
            if(EXISTS "${WL2_LIBMEMBUS_ROOT}/include/libmembus/memcmd.h")
                ...
                if(EXISTS "${WL2_LIBMEMBUS_ROOT}/include/libmembus/mempkt.h")
                    target_compile_definitions(wl2_libmembus_dependency PUBLIC WL2_LIBMEMBUS_HAS_2_1_SURFACE=1)
                else()
                    target_compile_definitions(wl2_libmembus_dependency PUBLIC WL2_LIBMEMBUS_HAS_2_1_SURFACE=0)
                endif()
                if(POLICY CMP0167)
                    cmake_policy(PUSH)
                ...
                target_compile_definitions(wl2_libmembus_dependency PUBLIC WL2_LIBMEMBUS_HAS_1_2_SURFACE=0 WL2_LIBMEMBUS_HAS_2_1_SURFACE=0)
            ...
            set(WL2_LIBMEMBUS_PROVIDER_USED local PARENT_SCOPE)
            if(WL2_LIBMEMBUS_SUMMARY_PROVIDER)
                set(_wl2_libmembus_summary_provider "${WL2_LIBMEMBUS_SUMMARY_PROVIDER}")
            else()
                set(_wl2_libmembus_summary_provider local)
            endif()
            wl2_dependency_note_result(libmembus "${_wl2_libmembus_summary_provider}" "${WL2_LIBMEMBUS_ROOT}")
    ...
    if(WL2_LIBMEMBUS_PROVIDER STREQUAL "fetch" OR WL2_LIBMEMBUS_PROVIDER STREQUAL "auto")
        if(WL2_LIBMEMBUS_PROVIDER STREQUAL "auto")
        ...
        if(_wl2_fetched_libmembus_root)
            ...
            set(WL2_LIBMEMBUS_SUMMARY_PROVIDER download)
            wl2_find_libmembus()
            set(WL2_HAVE_LIBMEMBUS "${WL2_HAVE_LIBMEMBUS}" PARENT_SCOPE)
            set(WL2_LIBMEMBUS_TARGET "${WL2_LIBMEMBUS_TARGET}" PARENT_SCOPE)
            if(WL2_HAVE_LIBMEMBUS)
                set(WL2_LIBMEMBUS_PROVIDER_USED fetch PARENT_SCOPE)
            else()
                set(WL2_LIBMEMBUS_PROVIDER_USED "${WL2_LIBMEMBUS_PROVIDER_USED}" PARENT_SCOPE)
            endif()
            return()
        elseif(WL2_LIBMEMBUS_PROVIDER STREQUAL "fetch")
    ...
    if(WL2_LIBMEMBUS_PROVIDER STREQUAL "package" OR WL2_LIBMEMBUS_PROVIDER STREQUAL "auto")
        ...
        if(TARGET libmembus::libmembus)
            ...
            target_compile_definitions(wl2_libmembus_dependency INTERFACE WL2_LIBMEMBUS_HAS_2_1_SURFACE=1)
            set(WL2_HAVE_LIBMEMBUS TRUE PARENT_SCOPE)
            set(WL2_LIBMEMBUS_TARGET wl2_libmembus_dependency PARENT_SCOPE)
            set(WL2_LIBMEMBUS_PROVIDER_USED package PARENT_SCOPE)
            wl2_dependency_note_result(libmembus system "libmembus::libmembus")
    ...
    wl2_dependency_note_result(libmembus DISABLED "not found")
endfunction()
