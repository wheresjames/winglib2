...
function(wl2_find_quickjs)
    ...
    if(WL2_QUICKJS_PROVIDER STREQUAL "off")
        wl2_dependency_note_result(quickjs DISABLED "WL2_DEPS_QUICKJS=off")
    ...
    if(NOT WL2_QUICKJS_PROVIDER STREQUAL "package" AND NOT WL2_QUICKJS_PROVIDER STREQUAL "fetch")
        foreach(_root IN LISTS _quickjs_roots)
            ...
            if(quickjs_FOUND)
                ...
                wl2_dependency_note_result(quickjs local "${_root}")
                set(WL2_HAVE_QUICKJS TRUE PARENT_SCOPE)
                return()
            endif()
        endforeach()
    ...
    if(WL2_QUICKJS_PROVIDER STREQUAL "fetch" OR WL2_QUICKJS_PROVIDER STREQUAL "auto")
        ...
        wl2_dependency_note_result(quickjs download "${WL2_QUICKJS_VERSION} ${_quickjs_install_root}")
        set(WL2_HAVE_QUICKJS TRUE PARENT_SCOPE)
        return()
    endif()
    ...
    if(WL2_QUICKJS_PROVIDER STREQUAL "package" OR WL2_QUICKJS_PROVIDER STREQUAL "auto")
        ...
        if(QUICKJS_INCLUDE_DIR AND QUICKJS_LIBRARY)
            ...
            wl2_dependency_note_result(quickjs system "${QUICKJS_LIBRARY}")
            set(WL2_HAVE_QUICKJS TRUE PARENT_SCOPE)
            return()
        endif()
    ...
    wl2_dependency_note_result(quickjs DISABLED "not found")
    set(WL2_HAVE_QUICKJS FALSE PARENT_SCOPE)
endfunction()
