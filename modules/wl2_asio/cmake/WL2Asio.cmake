...
function(wl2_find_asio)
    ...
    # fetch / auto(+WL2_FETCH_DEPS): download a pinned standalone Asio release.
    if(WL2_ASIO_PROVIDER STREQUAL "fetch" OR (WL2_ASIO_PROVIDER STREQUAL "auto" AND WL2_FETCH_DEPS))
        if(WL2_FETCH_DEPS)
            ...
            return()
        elseif(WL2_ASIO_PROVIDER STREQUAL "fetch")
            message(FATAL_ERROR "WL2_ASIO_PROVIDER=fetch but WL2_FETCH_DEPS=OFF")
        endif()
    endif()
